...
describe('Service Tests', () => {
  describe('Albums Service', () => {
    ...
    let expectedResult: IAlbums | IAlbums[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Albums(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Albums', () => {
        ...
        service.create(new Albums()).subscribe(resp => (expectedResult = resp.body));
